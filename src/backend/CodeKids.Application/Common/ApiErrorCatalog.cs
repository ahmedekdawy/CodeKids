...
public static class ApiErrorCatalog
{
    private static readonly Dictionary<string, string> Exact = new(StringComparer.Ordinal)
    {
        ...
        ["Question type must be ShortAnswer, MultipleChoice, Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, Order, or Map."] = "api.errors.assignment.questionTypeInvalid",
        ["Question type must be Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, ShortAnswer, Order, or Map."] = "api.errors.questionBank.questionTypeInvalid",
