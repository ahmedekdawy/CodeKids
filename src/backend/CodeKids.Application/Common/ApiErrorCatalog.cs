...
public static class ApiErrorCatalog
{
    private static readonly Dictionary<string, string> Exact = new(StringComparer.Ordinal)
    {
        ...
        ["Student classroom attendance not found."] = "api.errors.studentAttendance.notFound",
        ["Student attendance date is required."] = "api.errors.studentAttendance.dateRequired",
        ["This classroom is not assigned to you."] = "api.errors.studentAttendance.classroomNotAssigned",
        ["Student is not enrolled in this classroom."] = "api.errors.studentAttendance.studentNotEnrolled",
        ["Attendance status must be Present or Absent."] = "api.errors.studentAttendance.statusInvalid",
        ...
        ["Question type must be ShortAnswer, MultipleChoice, Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, Order, Map, or Complete."] = "api.errors.assignment.questionTypeInvalid",
        ["Question type must be Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, ShortAnswer, Order, Map, or Complete."] = "api.errors.questionBank.questionTypeInvalid",
        ["Order questions require each option exactly once in the correct sequence."] = "api.errors.questionBank.orderSequenceInvalid",
        ["Map questions need at least one marker on the image."] = "api.errors.questionBank.mapMarkersRequired",
        ["Map questions require a correct answer for each marker."] = "api.errors.questionBank.mapAnswersRequired",
        ["Map questions require a map image."] = "api.errors.questionBank.mapImageRequired",
        ...
        ["You cannot deactivate your own account."] = "api.errors.admin.cannotDeactivateSelf",
        ["Cannot deactivate the last Super Admin."] = "api.errors.admin.cannotDeactivateLastSuperAdmin",
        ["This account is inactive."] = "api.errors.auth.accountInactive",
