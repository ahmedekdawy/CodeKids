...
public static class ApiErrorCatalog
{
    private static readonly Dictionary<string, string> Exact = new(StringComparer.Ordinal)
    {
        ...
        ["Question type must be ShortAnswer, MultipleChoice, Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, or Order."] = "api.errors.assignment.questionTypeInvalid",
        ["Question type must be Choose, TrueFalse, SingleChoice, MultiChoice, Paragraph, Underline, FreeText, ShortAnswer, or Order."] = "api.errors.questionBank.questionTypeInvalid",
